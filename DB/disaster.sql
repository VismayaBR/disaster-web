...
(2, 'camp 2', 'vadakara', 'postoffice', '1234567890', 'camp2@gmail.com');
...
(2, 8, 'org2', 'org2@gmail.com', '7410852963', 'kannur', 0);
...
--
ALTER TABLE `login_tb`
  MODIFY `login_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `notification_tb`
--
ALTER TABLE `notification_tb`
  MODIFY `notify_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `requirements_tb`
  MODIFY `requirement_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
