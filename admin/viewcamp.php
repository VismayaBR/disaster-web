                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header" align="center">
                                <strong  class="card-title">Camp data</strong> 
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="table table-bordered">
                                           ...
                                           <td><?php echo $row['phone_no'];?></td>
                                            ...
                                            <td align="center"> 
                                                <a href="delete-camp.php?id=<?php echo $row['camp_id'];?>"  onclick="return confirm('delete this record')" class="btn btn-danger btn-sm">REMOVE</a>
                                            </td>
