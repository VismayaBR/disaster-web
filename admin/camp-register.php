...
if(isset($_POST['sub'])){
    ...
    mysqli_query($conn,"insert into login_tb(user_name,password,type )values('$user','$pass','camporganizer')");
    $log = mysqli_insert_id($conn);
    mysqli_query($conn,"insert into organizer(login_id,name,email,mobile,place)values('$log','$nm','$em','$mb','$pl')");
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post">
                    ...
                    <div class="wrap-input100 validate-input" >
						...
						<span class="focus-input100" data-placeholder="place"></span>
					</div>
                    <div class="wrap-input100 validate-input" >
